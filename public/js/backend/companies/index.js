$(function () {
    ...
    $("#datalist").tabulator({
        ...
        columns: [
            ...
            {title: "Email", field: "email", width: 45, headerFilter: "input", headerFilterPlaceholder: " "},
			{title: "Postcode", field: "postcode", width: 50, headerFilter:"input", headerFilterPlaceholder: " "},
            {title: "Prefecture", field: "prefecture", width: 45, headerFilter: "input", headerFilterPlaceholder: " "},
            {title: "Address", field: "address", width: 45, headerFilter: "input", headerFilterPlaceholder: " "},
            {title: "Action", field: "action", align: "center", headerFilter: false, width: 45, formatter: formatActionField, headerFilterPlaceholder: " ", headerSort: false, frozen: true}
        ],
